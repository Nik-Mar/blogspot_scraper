...
def count_occurrences_vectorized(_df, year):
    ...
    # Save the result in a file for the year
...
directory_path = 'processed_blogs'  # To the path of the folder with preprocessed blog data
...
with open('all_blogs_combined.json', 'r', encoding='utf-8') as f:  # This file is kept as zipped for storage purposes
...
print (f'prevalence is {(len(a) - 2) / len(b)}') #Here -2 was added because year and the word are included to the set as values and we are only interested in the blognames
